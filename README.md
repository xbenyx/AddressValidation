...
This app validates addresses. In some cases, customers make mistakes or sometimes staff members input the address manually in their ERP system causing errors. With an address validation tool you can save time and money as it will detect than an address is incorrect before you send it over.
...
i.e. https://api.nextbillion.io/h/geocode?key={{apitoken}}&q=4 Torrelavega, Spain Perfect Score&%26limit%3D=3 &%26in%3D=ES
